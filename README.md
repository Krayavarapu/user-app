...
The repo root includes `render.yaml` (Blueprint) for this service with `rootDir: user-app`.

1. In [Render](https://dashboard.render.com), **New → Blueprint** (or connect the repo and apply the blueprint).
